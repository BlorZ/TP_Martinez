...
<body>
	...
	<!-- Corps de la page -->
	<div class="container">
		<form role="form" id="addVirement" method="POST" action="addVirement">
	        <div class="form-group float-label-control">
	            <label for="">Libellé de la transaction</label>
	            <input name="libelle" type="text" class="form-control" placeholder="Libellé">
	        </div>
	        <div class="form-group float-label-control">
	            <label for="">Montant</label>
	            <input name="montant" type="number" step="0.01" class="form-control" placeholder="Montant">
	        </div>
	        <div class="form-group float-label-control">
	            <label for="">Compte destinataire</label>
	            <input type="text" name="idCompteCreditaire" class="form-control" placeholder="Compte destinataire">
	        </div>
	        <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
	        <input type="hidden" name="idCompteDebitaire" value="${idCompteDebitaire}" />
